...
<div class="woocommerce-tabs">
	<ul class="tab-product nav nav-tabs">
		...
		<?php if (!$vendor_rating_page) { ?>
			<li><a data-toggle="tab" href="#tabs-list-review"><?php esc_html_e( 'Review', 'kossy' ); ?></a></li>
		<?php } ?>
		

		<?php if ( !empty($shipping_policy) || !empty($return_policy) ) { ?>
			<li><a data-toggle="tab" href="#tabs-list-shipping"><?php esc_html_e( 'Shipping Policy', 'kossy' ); ?></a></li>
		<?php } ?>
	</ul>
			...
			<div class="tab-pane" id="tabs-list-shipping">
				...
				<?php if ( $shipping_policy != '' ):  ?>
					<div class="shipping_policy">
						<h3><?php esc_html_e( 'Shipping Policy', 'kossy' ); ?></h3>
				...
				<?php if ( $return_policy != '' ):  ?>
					<div class="return_policy">
						<h3><?php esc_html_e( 'Return Policy', 'kossy' ); ?></h3>
