				...
				<div class="store-info pull-left">
					   	...
					   	<div class="media-body media-middle">
					   		...
					   		<div class="rating-products-wrapper">
								<div class="total-products">
									<span class="total-label"><?php esc_html_e('Total products', 'kossy'); ?></span>
									<?php
			   	...
			   	<div class="store-aurhor pull-right">
					<div class="store-aurhor-inner">
						...
						<a href="mailto:<?php echo trim($user_info->data->user_email); ?>" class="btn-mess"><?php esc_html_e( 'Send a message', 'kossy' ); ?></a>
					</div>
				</div>
		...
		<div class="woocommerce-tabs">
			<ul class="tab-product nav nav-tabs">
				...
				<?php if ($shop_description != '') { ?>
					<li class="active"><a data-toggle="tab" href="#tabs-list-about"><?php esc_html_e( 'About Shop', 'kossy' ); ?></a></li>
				<?php } ?>
				<li><a data-toggle="tab" href="#tabs-list-best-deals"><?php esc_html_e( 'Best Deals', 'kossy' ); ?></a></li>
