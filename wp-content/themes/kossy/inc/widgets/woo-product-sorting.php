...
class Kossy_Widget_Woo_Product_Sorting extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description	= esc_html__( 'Display a product sorting list.', 'kossy' );
		$this->widget_id          	= 'apus_woocommerce_widget_product_sorting';
		$this->widget_name        	= esc_html__( 'Apus WooCommerce Product Sorting', 'kossy' );
		$this->settings           	= array(
			'title'  => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Sort By', 'kossy' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( 1 != $wp_query->found_posts || woocommerce_products_will_display() ) {
			...
			$catalog_orderby_options = apply_filters( 'woocommerce_catalog_orderby', array(
				'menu_order'	=> esc_html__( 'Default', 'kossy' ),
				'popularity' 	=> esc_html__( 'Popularity', 'kossy' ),
				'rating'     	=> esc_html__( 'Average rating', 'kossy' ),
				'date'       	=> esc_html__( 'Newness', 'kossy' ),
				'price'      	=> esc_html__( 'Price: Low to High', 'kossy' ),
				'price-desc'	=> esc_html__( 'Price: High to Low', 'kossy' )
			) );
...
register_widget( 'Kossy_Widget_Woo_Product_Sorting' );