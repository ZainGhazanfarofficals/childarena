...
class Kossy_Widget_Woo_Layered_Nav extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display a list of attributes to filter products in your store.', 'kossy' );
		$this->widget_id          = 'apus_woocommerce_layered_nav';
		$this->widget_name        = esc_html__( 'Apus Filter Products by Attribute', 'kossy' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			...
			'attribute' => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'kossy' ),
				'options' => $attribute_array,
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'kossy' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'kossy' ),
					'or'  => esc_html__( 'OR', 'kossy' ),
				),
			),
		);
	}
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type ) {
		...
		foreach ( $terms as $term ) {
			...
			if ( $count > 0 || $option_is_set ) {
				...
				$term_html = '<a href="' . $link . '">' . self::display_swatch($attr->attribute_type, $value) . esc_html( $term->name ) . '</a>';
			} else {
				$link      = false;
				$term_html = '<span>'. self::display_swatch($attr->attribute_type, $value) . esc_html( $term->name ) . '</span>';
			}
...
register_widget( 'Kossy_Widget_Woo_Layered_Nav' );