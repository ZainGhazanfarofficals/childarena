...
if ( !class_exists("Kossy_Nav_Menu") ) {
    class Kossy_Nav_Menu extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ( isset($item->apus_text_label) && !empty($item->apus_text_label) ) {
                switch ( $item->apus_text_label ) {
                    case 'label_new':
                        $text_label  = esc_html__('New', 'kossy');
                        break;

                    case 'label_hot':
                        $text_label  = esc_html__('Hot', 'kossy');
                        break;

                    case 'label_featured':
                        $text_label  = esc_html__('Featured', 'kossy');
                        break;
