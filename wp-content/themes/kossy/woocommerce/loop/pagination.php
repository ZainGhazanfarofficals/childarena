...
$pagination_type = kossy_get_config('product_pagination', 'default');
...
?>
	<div class="ajax-pagination <?php echo trim($pagination_type == 'loadmore' ? 'loadmore-action' : 'infinite-action'); ?>">
		...
		<a href="#" class="apus-loadmore-btn"><?php esc_html_e( 'load more items', 'kossy' ); ?></a>
		<a href="#" class="apus-allproducts"><?php esc_html_e( 'All products loaded.', 'kossy' ); ?></a>
	</div>
<?php
} else {
?>
