...
$action = isset($_COOKIE['kossy_login_register']) && in_array($_COOKIE['kossy_login_register'], $args) ? $_COOKIE['kossy_login_register'] : '#customer_login';
?>
			...
			<div class="form-group form-row">
				...
				<div class="form-group clearfix">
					...
					<span class="lost_password pull-right">
						<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'kossy' ); ?></a>
					</span>
				</div>
				<input type="submit" class="btn btn-theme btn-block" name="login" value="<?php esc_html_e( 'sign in', 'kossy' ); ?>" />
			</div>
		...
		<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
			<div class="create text-center">
				<div class="line-border center">
					<span class="center-line"><?php echo esc_html__('or','kossy') ?></span>
				</div>
				<a class="creat-account register-login-action" href="#customer_register"><?php echo esc_html__('CREATE AN ACCOUNT','kossy'); ?></a>
			</div>
		<?php endif; ?>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div id="customer_register" class="content-register register_login_wrapper <?php echo trim($action == '#customer_register' ? 'active' : ''); ?>">
		...
		<h2 class="title"><?php esc_html_e( 'Register', 'kossy' ); ?></h2>
		<form method="post" class="register widget" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="form-group form-row form-row-wide">
					<label for="reg_username"><?php esc_html_e( 'Username', 'kossy' ); ?> <span class="required">*</span></label>
			...
			<p class="form-group form-row form-row-wide">
				<label for="reg_email"><?php esc_html_e( 'Email address', 'kossy' ); ?> <span class="required">*</span></label>
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="form-group form-row form-row-wide">
					<label for="reg_password"><?php esc_html_e( 'Password', 'kossy' ); ?> <span class="required">*</span></label>
					<input type="password" class="input-text form-control" name="password" id="reg_password" />
				</p>

			<?php else : ?>

				<p><?php esc_html_e( 'A password will be sent to your email address.', 'kossy' ); ?></p>
			...
			<p class="form-group form-row wrapper-submit">
				...
				<input type="submit" class="btn btn-primary btn-block" name="register" value="<?php esc_html_e( 'Register', 'kossy' ); ?>" />
			</p>
		...
		<div class="create text-center">
			...
			<a class="login-account register-login-action" href="#customer_login"><?php echo esc_html__('SIGN IN','kossy'); ?></a>
		</div>
