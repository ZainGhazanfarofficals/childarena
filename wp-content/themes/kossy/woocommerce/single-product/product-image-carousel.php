...
if(has_post_thumbnail()){
	...
	$_images[] = '<img src="'.wc_placeholder_img_src().'" />';
}
...
?>
<!-- Wrapper for slides -->
<div class="slick-carousel quickview-slick" data-items="1" data-smallmedium="1" data-extrasmall="1" data-pagination="false" data-nav="true" data-infinite="true">
