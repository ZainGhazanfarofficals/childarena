...
$number_product_thumbs = kossy_get_config('number_product_thumbs', 4);
if ( $layout == 'v1' || $layout == 'v3' ) {
?>
	<div class="apus-woocommerce-product-gallery-wrapper">
	      ...
	      if (!empty($video)) {
	        ...
	        <div class="video">
	          <a href="<?php echo esc_url($video); ?>" class="popup-video">
	            ...
	            <span class="text-theme"><?php echo esc_html__('Watch video', 'kossy'); ?></span>
	          </a>
	        </div>
	        <?php
	      }
		...
		<div class="slick-carousel apus-woocommerce-product-gallery" data-carousel="slick" data-items="1" data-smallmedium="1" data-extrasmall="1" data-pagination="false" data-nav="false" data-slickparent="true">
			...
			if ( has_post_thumbnail() ) {
				...
				$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_attr__( 'Awaiting product image', 'kossy' ) );
				$html .= '</div>';
			}
	...
	<div class="wrapper-thumbs">
		<div class="slick-carousel apus-woocommerce-product-gallery-thumbs <?php echo esc_attr($thumbs_pos == 'thumbnails-left' || $thumbs_pos == 'thumbnails-right' ? 'vertical' : ''); ?>" data-carousel="slick" data-items="<?php echo esc_attr($number_product_thumbs); ?>" data-smallmedium="<?php echo esc_attr($number_product_thumbs); ?>" data-extrasmall="<?php echo esc_attr($number_product_thumbs); ?>" data-smallest="<?php echo esc_attr($number_product_thumbs); ?>" data-pagination="false" data-nav="true" data-asnavfor=".apus-woocommerce-product-gallery" data-slidestoscroll="1" data-focusonselect="true" <?php echo trim($thumbs_pos == 'thumbnails-left' || $thumbs_pos == 'thumbnails-right' ? 'data-vertical="true"' : ''); ?>>
			<?php
			...
			echo apply_filters( 'kossy_woocommerce_single_product_image_thumbnail_html', $html, get_post_thumbnail_id( $post->ID ) );
			...
			if ( $attachment_ids && has_post_thumbnail() ) {
				foreach ( $attachment_ids as $attachment_id ) {
					...
					echo apply_filters( 'kossy_woocommerce_single_product_image_thumbnail_html', $html, $attachment_id );
				}
			}
	...
	<div class="apus-woocommerce-product-gallery-wrapper">
		...
		<div class="apus-woocommerce-product-gallery">
			...
			if ( has_post_thumbnail() ) {
				...
				$html  = '<div class="woocommerce-product-gallery__image--placeholder">';
				$html .= sprintf( '<img src="%s" alt="%s" class="wp-post-image" />', esc_url( wc_placeholder_img_src() ), esc_html__( 'Awaiting product image', 'kossy' ) );
				$html .= '</div>';
			}
